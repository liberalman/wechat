import '../from.dart';
import '../../../tools/wechat_flutter.dart' as prefix1;
import '../../../ui/w_pop/friend_pop.dart';
...
class ItemDynamic extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double imageWidth = (MediaQuery.of(context).size.width - 20 - 50 - 10) /
        ((imageSize == 3 || imageSize > 4)
            ? 3.0
            : (imageSize == 2 || imageSize == 4) ? 2.0 : 1.5);

    double videoWidth = (MediaQuery.of(context).size.width - 20 - 50 - 10) / 2.2;
